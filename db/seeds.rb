...
@fourth_post = Post.create!(title:'Are We the Baddies? One brooklyn boy\'s take on Promising young woman',author:'Matt LaDouche', content:'', main_img_url:'', thumbnail_url:'', post_type:'review')

@fifth_post = Post.create!(title:'Reviewing the Criterion movies I own but haven\'t watched.', content:'', main_img_url:'Mark Jason', thumbnail_url:'', post_type:'review')

@sixth_post = Post.create!(title:'Listening to Sour when you are the Joshua Basset in the relationship', content:'', main_img_url:'Tyler Garrison', thumbnail_url:'', post_type:'review')
